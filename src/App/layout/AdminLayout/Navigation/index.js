...
const mapStateToProps = state => {
    return {
        ...
        preLayout: state.app.preLayout,
        collapseMenu: state.app.collapseMenu,
        layoutType: state.app.layoutType,
        navBackColor: state.app.navBackColor,
        navBackImage: state.app.navBackImage,
        navIconColor: state.app.navIconColor,
        navBrandColor: state.app.navBrandColor,
        layout6Background: state.app.layout6Background,
        layout6BackSize: state.app.layout6BackSize,
        rtlLayout: state.app.rtlLayout,
        navFixedLayout: state.app.navFixedLayout,
        boxLayout: state.app.boxLayout,
        navDropdownIcon: state.app.navDropdownIcon,
        navListIcon: state.app.navListIcon,
        navActiveListColor: state.app.navActiveListColor,
        navListTitleColor: state.app.navListTitleColor,
        navListTitleHide: state.app.navListTitleHide
    }
};
